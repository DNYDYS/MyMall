package com.admin.mall.service.impl;
...
public class UmsMemberServiceImpl implements UmsMemberService {
     ...
     */
    @Override
    public CommonResult generatrAuthcode(String telephone) {
     ...
     */
    @Override
    public CommonResult verifAuthCode(String telephone, String authCode) {
